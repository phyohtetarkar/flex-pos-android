...
import com.flex.pos.databinding.EditDiscountBinding
...
import com.flex.pos.ui.views.tax.AssignItemActivity
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        viewModel.saveSuccess.observe(this, Observer {
            if (it == true) {
                ...
                AlertUtil.showToast(this, resources.getString(R.string.fail_to_save, "discount"))
            }
        })
